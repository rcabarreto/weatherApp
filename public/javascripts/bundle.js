...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherHeader = __webpack_require__(162);
	var WeatherLoader = __webpack_require__(163);
	var WeatherInfo = __webpack_require__(164);
	var WeatherFooter = __webpack_require__(165);
	var WeatherError = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherInfo = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var currently = this.props.currently;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement("span", { id: "weather-icon", className: "wi wi-forecast-io-" + currently.icon, title: currently.summary }),
	        React.createElement(
	          "span",
	          { id: "weather-temp", className: "metric-stat-number" },
	          parseInt(currently.temperature),
	          "\xB0"
	        ),
	        React.createElement(
	          "span",
	      ...
	      React.createElement("div", { id: "dailyWeather" })
	    );
	  }
	});
